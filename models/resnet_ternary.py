...
def Ternaryconv3x3(in_planes, out_planes, stride=1):
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,do_bntan=True):
        ...
        self.conv1 = Ternaryconv3x3(inplanes, planes, stride)
        self.bn1 = nn.BatchNorm2d(planes)
        self.tanh1 = nn.Hardtanh(inplace=True)
        self.conv2 = Ternaryconv3x3(planes, planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = TernaryConv2d(inplanes, planes, kernel_size=1, bias=False)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = TernaryConv2d(planes, planes, kernel_size=3, stride=stride,
                               padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv3 = TernaryConv2d(planes, planes * 4, kernel_size=1, bias=False)
    ...
    def _make_layer(self, block, planes, blocks, stride=1,do_bntan=True):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                TernaryConv2d(self.inplanes, planes * block.expansion,
...
class ResNet_imagenet(ResNet):
    ...
    def __init__(self, num_classes=1000,
        ...
        self.inplanes = 64
        self.conv1 = TernaryConv2d(3, 64, kernel_size=7, stride=2, padding=3,
                               bias=False)
...
class ResNet_cifar10(ResNet):
    ...
    def __init__(self, num_classes=10,
        ...
        n = int((depth - 2) / 6)
        self.conv1 = TernaryConv2d(3, 16*self.inflate, kernel_size=3, stride=1, padding=1,
                               bias=False)
        ...
        self.fc = TernaryLinear(64*self.inflate, num_classes)
